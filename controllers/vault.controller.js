...
const addEntry = asyncHandler(async(req,res)=>{
    ...
    try{
        ...
        // const spassowrd = encryptWithKeyword(upassword,keyword);
        // console.log("Encrypted password : ",spassowrd);
        // const susername = encryptWithKeyword(username,keyword);
        // console.log("Encrypted Website : ",susername);
        // const swebsite = encryptWithKeyword(website,keyword);
